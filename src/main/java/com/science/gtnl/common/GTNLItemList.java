...
public enum GTNLItemList {
    ...
    Integrated_Output_Hatch_ULV,
    Integrated_Output_Hatch_LV,
    Integrated_Output_Hatch_MV,
    Integrated_Output_Hatch_HV,
    Integrated_Output_Hatch_EV,
    Integrated_Output_Hatch_IV,
    Integrated_Output_Hatch_LuV,
    Integrated_Output_Hatch_ZPM,
    Integrated_Output_Hatch_UV,
    Integrated_Output_Hatch_UHV,
    Integrated_Output_Hatch_UEV,
    Integrated_Output_Hatch_UIV,
    Integrated_Output_Hatch_UMV,
    Integrated_Output_Hatch_UXV,
    Integrated_Output_Hatch_MAX,
