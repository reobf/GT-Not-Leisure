...
public class EyeOfHarmonyRecipes {
    ...
    private void specialStarGateRecipe(final HashMap<String, EyeOfHarmonyRecipe> hashMap, final BlockDimensionDisplay blockDimensionDisplay) {
    ...
    public EyeOfHarmonyRecipes() {
        ...
        for (EyeOfHarmonyRecipe recipe : recipeHashMap.values()) {
            ...
            GTValues.RA.stdBuilder()
                    ...
                    .itemOutputs(GTUtility.copyAmountUnsafe(1919810, getModItem(ScienceNotLeisure.ID, "StargateTier9", 1, 0)))
                    .fluidInputs(
