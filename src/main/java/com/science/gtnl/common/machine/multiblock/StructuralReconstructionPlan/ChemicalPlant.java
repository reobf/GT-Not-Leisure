...
public class ChemicalPlant extends MultiMachineBase<ChemicalPlant> implements ISurvivalConstructable {
    ...
    public int getMaxParallelRecipes() {
        return Math.max(1, Math.min(256, (int) Math.pow(2, GTUtility.getTier(this.getMaxInputVoltage()))));
    }
