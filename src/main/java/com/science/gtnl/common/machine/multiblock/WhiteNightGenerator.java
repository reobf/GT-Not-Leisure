...
public class WhiteNightGenerator extends MultiMachineBase<WhiteNightGenerator>
    ...
    protected MultiblockTooltipBuilder createTooltip() {
        ...
        tt.addMachineType(TextLocalization.Tooltip_WhiteNightGenerator_MachineType)
            ...
            .addInfo(TextLocalization.Tooltip_WhiteNightGenerator_01)
            .addInfo(TextLocalization.Tooltip_WhiteNightGenerator_02)
            .addInfo(TextLocalization.Tooltip_WhiteNightGenerator_03)
            .addInfo(TextLocalization.Tooltip_WhiteNightGenerator_04)
            .addSeparator()
            .addInfo(TextLocalization.Tooltip_WhiteNightGenerator_05)
            .addInfo(TextLocalization.Tooltip_WhiteNightGenerator_06)
            .addInfo(TextLocalization.Tooltip_WhiteNightGenerator_07)
            .addSeparator()
            .addInfo(TextLocalization.Tooltip_WhiteNightGenerator_08)
            .addInfo(TextLocalization.Tooltip_WhiteNightGenerator_09)
            .addInfo(TextLocalization.Tooltip_WhiteNightGenerator_10)
            .addSeparator()
            .addInfo(TextLocalization.Tooltip_WhiteNightGenerator_11)
            .addInfo(TextLocalization.Tooltip_WhiteNightGenerator_12)
            .addInfo(TextLocalization.Tooltip_WhiteNightGenerator_13)
            .addInfo(TextLocalization.Tooltip_WhiteNightGenerator_14)
            .addSeparator()
            .addInfo(TextLocalization.Tooltip_WhiteNightGenerator_15)
            .addInfo(TextLocalization.Tooltip_WhiteNightGenerator_16)
            .addInfo(TextLocalization.Tooltip_WhiteNightGenerator_17)
            .addInfo(TextLocalization.Tooltip_WhiteNightGenerator_18)
            .addSeparator()
            .addInfo(TextLocalization.Tooltip_WhiteNightGenerator_19)
            .addInfo(TextLocalization.Tooltip_WhiteNightGenerator_20)
            .addSeparator()
            .addInfo(TextLocalization.Tooltip_WhiteNightGenerator_21)
            .addInfo(TextLocalization.Tooltip_WhiteNightGenerator_22)
            .addInfo(TextLocalization.Tooltip_WhiteNightGenerator_23)
            .addSeparator()
            .addInfo(TextLocalization.Tooltip_WhiteNightGenerator_24)
            .addInfo(TextLocalization.Tooltip_WhiteNightGenerator_25)
            .addInfo(TextLocalization.Tooltip_WhiteNightGenerator_26)
            .addInfo(TextLocalization.Tooltip_WhiteNightGenerator_27)
            .addInfo(TextLocalization.Tooltip_WhiteNightGenerator_28)
            .addInfo(TextLocalization.Tooltip_WhiteNightGenerator_29)
            .addInfo(TextLocalization.Tooltip_WhiteNightGenerator_30)
            .addInfo(TextLocalization.Tooltip_WhiteNightGenerator_31)
            .addInfo(TextLocalization.Tooltip_WhiteNightGenerator_32)
            .addInfo(TextLocalization.Tooltip_WhiteNightGenerator_33)
            .addSeparator()
            .addInfo(TextLocalization.Tooltip_WhiteNightGenerator_34)
            .addInfo(TextLocalization.Tooltip_WhiteNightGenerator_35)
            .addInfo(TextLocalization.Tooltip_WhiteNightGenerator_36)
            .addInfo(TextLocalization.Tooltip_WhiteNightGenerator_37)
            .addInfo(TextLocalization.Tooltip_WhiteNightGenerator_38)
            .addInfo(TextLocalization.Tooltip_WhiteNightGenerator_39)
            .addInfo(TextLocalization.Tooltip_WhiteNightGenerator_40)
            .addInfo(TextLocalization.Tooltip_WhiteNightGenerator_41)
            .addInfo(TextLocalization.Tooltip_WhiteNightGenerator_42)
            .addInfo(TextLocalization.Tooltip_WhiteNightGenerator_43)
            .addInfo(TextLocalization.Tooltip_WhiteNightGenerator_44)
            .addSeparator()
            .addInfo(TextLocalization.Tooltip_WhiteNightGenerator_45)
            .addInfo(TextLocalization.Tooltip_WhiteNightGenerator_46)
            .addInfo(TextLocalization.Tooltip_WhiteNightGenerator_47)
            .addSeparator()
            .addInfo(TextLocalization.Tooltip_WhiteNightGenerator_48)
            .addInfo(TextLocalization.Tooltip_WhiteNightGenerator_49)
            .addInfo(TextLocalization.Tooltip_WhiteNightGenerator_50)
            .addInfo(TextLocalization.Tooltip_WhiteNightGenerator_51)
            .addSeparator()
