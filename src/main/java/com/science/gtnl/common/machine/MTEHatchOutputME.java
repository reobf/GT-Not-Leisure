...
public class MTEHatchOutputME extends MTEHatchOutput implements IPowerChannelState {
    ...
    private final long FluidBaseCapacity = 128_000_000;
    ...
    public void addAdditionalTooltipInformation(ItemStack stack, List<String> tooltip) {
        ...
        if (stack.hasTagCompound() && stack.stackTagCompound.hasKey("FluidBaseCapacity")) {
            tooltip.add(
                "Current cache capacity: " + EnumChatFormatting.YELLOW
                    + ReadableNumberConverter.INSTANCE
                        .toWideReadableForm(stack.stackTagCompound.getLong("FluidBaseCapacity"))
                    + "L");
        }
    }
