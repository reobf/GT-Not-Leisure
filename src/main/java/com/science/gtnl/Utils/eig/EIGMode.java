...
public abstract class EIGMode {
     ...
     *
     * @see IEIGBucketFactory#tryCreateBucket(EdenGarden, ItemStack)
     * @param greenhouse The {@link EdenGarden} that will contain the seed.
     ...
     */
    public EIGBucket tryCreateNewBucket(EdenGarden greenhouse, ItemStack input, int maxConsume, boolean simulate) {
        // Validate inputs
