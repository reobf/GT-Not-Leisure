...
public class CustomBlockBase extends BlockBase {
    ...
    public void addInformation(final ItemStack itemStack, final EntityPlayer player, final List<String> toolTip, final boolean advancedToolTips) {
        ...
        toolTip.add(StatCollector.translateToLocal("gt.coilheattooltip") + getHeat() + StatCollector.translateToLocal("gt.coilunittooltip"));
    }
}
